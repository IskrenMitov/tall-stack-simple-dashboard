...
@section('content')
    <div class="mx-auto max-w-7xl pt-8">
        <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-1">
            <div class="col-span-2">
                <h2 class="font-title">
                    Image Gallery for Author: {{ $author->name }}
                </h2>
            </div>
            <div class="float-right text-end">
                <a href="{{ route('authors.index') }}" class="btn-link hover:underline inline-flex items-center">
                    <button type="button"
                    ...
                    <p class="ml-4 font-body">Back to Authors List</p>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl mt-8">
        <livewire:upload-image :imageable_type="\App\Models\Author::class" :imageable_id="$author->id"/>
    </div>
@endsection
